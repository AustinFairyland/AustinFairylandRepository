...
class DatetimeUtils:
    ...
    @classmethod
    def normdatetime_to_string(cls, __format=DateTimeFormat.DATETIME.value) -> str:
        """
    ...
    @classmethod
    def normnowdate_to_string(cls, __format=DateTimeFormat.DATE.value) -> str:
        """
    ...
    @classmethod
    def normnowtime_to_string(cls, __format: str = DateTimeFormat.TIME.value) -> str:
        """
    ...
    @classmethod
    def timestamp_to_datetimestring(cls, timestamp: Union[int, float], __format: str = DateTimeFormat.DATETIME.value) -> str:
        """
    ...
    @classmethod
    def string_to_timestamp(cls, string: str, __format: str = DateTimeFormat.DATETIME.value) -> float:
        """
    ...
    @classmethod
    def datetime_to_string(cls, datetime_object: datetime, __format: str = DateTimeFormat.DATETIME.value) -> str:
        """
    ...
    @classmethod
    def string_to_datetime(cls, string: str, format: str = DateTimeFormat.DATETIME.value) -> datetime:
        """
